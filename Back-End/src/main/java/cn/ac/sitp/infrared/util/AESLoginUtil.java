...
public class AESLoginUtil {
    ...
    public static final String KEY = "SITP0123456789AB";
    ...
    public static void main(String[] args) {
        try {
            String key = "TCMobile@sitplmi";
            System.out.println("=========================================");
            System.out.println(key);
            String encryptkey = AESLoginUtil.aesEncryptString("dcdoctor", KEY);

            System.out.println(key + " encryptkey: " + encryptkey);
            System.out.println("decryptkey:" + AESLoginUtil.aesDecryptString("Luy8hu34zsywWIhpO67g2A==", KEY));
